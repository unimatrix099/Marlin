...
#define USE_ZMIN_PLUG // used as Z probe
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 192 }  // default steps per unit for Kossel (GT2, 20 tooth)
